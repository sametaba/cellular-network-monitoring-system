...
**Example:**
```bash
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "network monitoring dashboard dark" --design-system -p "NetMap"
```
...
| Need | Domain | Example |
|------|--------|---------|
| Product type patterns | `product` | `--domain product "network monitoring SaaS"` |
| More style options | `style` | `--domain style "glassmorphism dark"` |
| Color palettes | `color` | `--domain color "tech dark navy"` |
| Font pairings | `typography` | `--domain typography "modern technical"` |
...
|------|----------|--------|----------------|
| **No Emoji as Structural Icons** | Use vector-based icons (e.g., Lucide, react-native-vector-icons, @expo/vector-icons). | Using emojis for navigation, settings, or system controls. | Emojis are font-dependent, inconsistent across platforms. |
